...
Решение:
    ...
    В модуле HomeWork009 содержится результат выполнения домашнего задания к Семинару 9
...
Решение:
    ...
    В модуле HomeWork010 содержится результат выполнения домашнего задания к Семинару 10
...
Решение:
    ...
    В модуле HomeWork011 содержится результат выполнения домашнего задания к Семинару 11
...
Решение:
    ...
    В модуле HomeWork012 содержится результат выполнения домашнего задания к Семинару 12